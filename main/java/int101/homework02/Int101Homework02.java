...
import int101s2023h02.src.work03Account.Account;
...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to use 1.2-1.4 and
        ...
        Utilitor utilitor1 = new Utilitor();

        System.out.println("--1.2--");
        System.out.println("Test String: " + utilitor1.testString("Hello Mars"));
//        System.out.println(utilitor1.testString(""));
//        System.out.println(utilitor1.testString());
        System.out.println("\n");

        System.out.println("--1.3--");
        System.out.println("Test Positive: " + utilitor1.testPositive(50.0));
//        System.out.println(utilitor1.testPositive(-1.0));
        System.out.println("\n");

        System.out.println("--1.4--");
        System.out.println("Check Digits of 1000000000 ISBN-10: " + utilitor1.computeIsbn10(100_000_000));
        System.out.println("Check Digits of 1276858095 ISBN-10: " + utilitor1.computeIsbn10(127_685_809));
//        System.out.println("Valid of 1276858095 ISBN-10: " +utilitor1.computeIsbn10(9_999_999_99));
        System.out.println("\n");
    }
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to use 2.6-2.10
        ...
        Person person1 = new Person("MJ", "Watson");
        System.out.println(person1);
        Person person2 = new Person("Jacob", "Batalon");
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to use 3.6-3.12
        ...
        Person personA = new Person("Tony","Stark");
        Person personB = new Person("Pete", "Maverick");
        ...
        System.out.println("Deposit 100000$: " + account1.deposit(100000.00));
        System.out.println("Account 1 balance: " + account1.getBalance()  + '\n');

        System.out.println("-- 3.9 --");

        System.out.println("Withdraw 2600$: " + account1.withdraw(2600.00));
        System.out.println("Account 1 balance: " + account1.getBalance() + '\n');

        System.out.println("-- 3.10 --");
        System.out.println("Before | Account1 balance: " + account1.getBalance() + " , Account2 balance: " + account2.getBalance());
        account1.transfer(5900.00,account2);
        System.out.println("Transfer 5900$ account1 -> account2");
